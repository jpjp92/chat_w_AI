...
System: I'm sorry, but it looks like the code got cut off while being generated. Let me complete and correct it for you. Below is the fully organized Streamlit application code, addressing the `NameError` issue and incorporating all the improvements (session management UI, usage stats, language selection, chat export, image reset, etc.) as requested. The code includes all necessary functions and ensures proper initialization to prevent errors like the one you encountered.

<xaiArtifact artifact_id="92e1d980-59f1-4259-b091-58ad2d66d70e" artifact_version_id="2bfad2d3-9893-4937-bfb9-e1e853c9ff45" title="app.py" contentType="text/python">
import streamlit as st
import google.generativeai as genai
import os
from datetime import datetime
